...
class LLaDAEvalHarness(LM):
    def __init__(
        ...
        **kwargs,
        ...
        self.speculative_interval = speculative_interval
        ...
        for batch in tqdm(batched_requests, desc="Generating..."):
            ...
            if self.use_cache:
                if self.dual_cache:
                    ...
                    generated_answer, nfe, avg_unmask = generate_with_prefix_cache(
                        self.model,
                        input_ids,
                        steps=self.steps,
                        gen_length=self.gen_length,
                        ...
                        speculative_interval=self.speculative_interval,
